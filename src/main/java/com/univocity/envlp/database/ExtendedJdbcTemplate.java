...
public class ExtendedJdbcTemplate extends JdbcTemplate {
	...
	public int update(final String table, Map<String, Object> data, String[] columnsToMatch) {
		return update(table, data, new LinkedHashSet<>(Arrays.asList(columnsToMatch)), null);
	}
