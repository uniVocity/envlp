...
public class PropertyBasedConfiguration {
	...
	/**
	 * Creates a configuration instance from an {@link InputStream}
	 *
	...
	/**
	 * Creates a configuration instance from a {@link Reader}
	 *
	 * @param inputProperties an input with properties.
	 *
	 * @throws IllegalConfigurationException if the input can't be read
	...
	/**
	 * Creates a configuration instance from a {@link File}
	 *
	 * @param inputProperties an input with properties.
	 *
	 * @throws IllegalConfigurationException if the input can't be read
	...
	private static InputStream openConfiguration(String... pathsToTry) {
		Utils.notEmpty("List of paths to look for a properties file", pathsToTry);
...
//		}
	...
	/**
	 * Given a path to a file, returns an instance of {@link File} for that path, ensuring the physical file
	...
	/**
	 * Given a path to a directory, returns an instance of {@link File} for that path, ensuring the physical
	 ...
	 * variables between '!{' and '}', and returns an instance of {@link File} for that path, ensuring the
